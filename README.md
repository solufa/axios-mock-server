...
If you want to create a file in CommonJS format, create a configuration file named `.mockserverrc` in advance.
...
If the build is successful, the `$ route.js` file is generated in the`mocks` directory.
...
Finally, import the `mocks/$route.js` file generated by `index.js` file etc. and pass it to the argument of axios-mock-server.  
...
Exclude `$route.js` or `$route.ts` generated by axios-mock-server in the build from [Git][git] monitoring.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>Enable watch mode and build the API every time a change is made.</td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        If multiple directories are specified, <code>$route.js</code> or <code>$route.ts</code> is generated in each directory.
      </td>
    </tr>
    <tr>
      ...
      <td><code>"js"</code></td>
      <td>Specify the extension of the file generated by the build.</td>
    </tr>
    <tr>
      <td><code>target</code></td>
      <td><code>"es6" | "cjs"</code></td>
      <td><code>"es6"</code></td>
      <td>Specify the code of the module to be generated in the build.</td>
    </tr>
  </tbody>
</table>
